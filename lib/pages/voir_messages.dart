...
class VoirMessages extends StatefulWidget {
  final String email;
  VoirMessages(this.email);

  @override
  State<VoirMessages> createState() => _VoirNotificationsState();
}

class _VoirNotificationsState extends State<VoirMessages> {
